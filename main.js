...
var length_of_name_of_student_aray= name_of_the_student_array. length; 
console.log(length_of_name_of_student_aray);


for (var k =  0; k < length_of_name_of_student_aray; k++)
{
      ...
      var lenght_of_name_of_students_array = name_of_the_student_array.length;
       console.log(lenght_of_name_of_students_array);
        for (var k = 0; k < lenght_of_name_of_students_array; k++) 
        {
             ...
             } //Additional activity function new_update() { 
